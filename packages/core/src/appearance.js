  ...
  game: {
    themes: [
      theme(
        ...
        'Sunny Quest',
        'light',
        'Warm cream and sky, coral buttons, chunky and round',
        font('Fredoka', `'Fredoka Variable', ${SANS}`, 600),
        font('Nunito', `'Nunito Variable', ${SANS}`),
        ['#fff6e3', '#ffffff', '#1f2a44', '#c9432c', '#1a7f86', '#f2b400', '#2f8a3b'],
      ),
      theme(
        'storybook',
        'Storybook',
        'light',
        'Parchment and ink, berry, forest and ochre, hand drawn',
        font('Patrick Hand', `'Patrick Hand', 'Comic Sans MS', ${SANS}`),
        font('Atkinson Hyperlegible', `'Atkinson Hyperlegible Next Variable', ${SANS}`),
        ['#f3e7cc', '#fbf4e2', '#3a2a1c', '#9a2c4b', '#2f6b3a', '#c98a1c', '#3f6f8f'],
      ),
      theme(
        'arcade',
        'Arcade',
        'dark',
        'Retro console, pixel type, brick, amber, leaf and cobalt',
      ...
      theme(
        ...
        'Night Owl',
        'dark',
        'Deep navy sky, moon yellow, lilac and soft teal',
        font('Baloo 2', `'Baloo 2 Variable', ${SANS}`, 800),
        font('Lexend', `'Lexend Variable', ${SANS}`),
        ['#0f1830', '#17233f', '#e9edf8', '#f3cf63', '#b8a2ff', '#5fd0bd', '#f4a57a'],
      ),
    ],
  },
  minimal: {
    themes: [
      theme(
        ...
        'Paper',
        'light',
        'Warm ivory notebook, ink blue, rust and sage',
        font('Fraunces', `'Fraunces Variable', ${SERIF}`, 500),
        font('Source Serif 4', `'Source Serif 4 Variable', ${SERIF}`),
        ['#faf5ea', '#fffdf7', '#1e2432', '#1f4e8c', '#a4461e', '#4f7c58', '#b08a2e'],
      ),
      theme(
        'nordic',
        'Nordic',
        'light',
        'Cool grey white, fjord blue, pine and clay, airy',
        font('Manrope', `'Manrope Variable', ${SANS}`, 700),
        font('Inter', `'Inter Variable', ${SANS}`),
        ['#f2f4f6', '#ffffff', '#16202b', '#2d6690', '#2b6a4f', '#b25a3a', '#7a8fa3'],
      ),
      theme(
        'midnight',
        'Midnight Library',
        'dark',
        'Green black study, brass, burgundy and parchment',
      ...
      theme(
        ...
        'Studio',
        'dark',
        'Warm graphite, terracotta, cream and olive',
        font('Syne', `'Syne Variable', ${SANS}`, 700),
