...
- [ ] Build: `npm ci && npm run build`. Upload `extension/dist/regimen-chromium-<version>.zip` as a new item.
- [ ] Store listing tab:
  ...
  - [ ] Homepage https://aryanmotiani.github.io/regimen/ and support https://github.com/AryanMotiani/regimen/issues.
- [ ] Privacy practices tab:
  ...
  - [ ] Privacy policy URL: https://aryanmotiani.github.io/regimen/privacy.html
