...
<template>
  <div>
    ...
    <textarea class="input min-h-24 font-mono text-[13px]" :value="modelValue" spellcheck="false" autocomplete="off"
      @input="emit('update:modelValue', $event.target.value)" @paste="block" @drop="block" aria-label="Confirmation sentence" />
